...
void Filter_Camera_Points( const pcl::PointCloud<pcl::PointXYZ>::Ptr cloud,  pcl::PointCloud<pcl::PointXYZ>::Ptr camera_cloud_filtered );
        
// Extracts pointcloud points that are below the floor plane. (CAMERA)
void NegativeLimitFilter( const pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud,  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_filtered );
      
// Extracts pointcloud points that are on the floor plane. (CAMERA)
void FloorProjection( const pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud,  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_filtered );
      
// Extracts pointcloud points from robots height to floor. (LIDAR)
void PointsToFloor( const pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud,  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_filtered );
