...
void pointcloudCallback(const sensor_msgs::PointCloud2ConstPtr& camera_cloud, const sensor_msgs::PointCloud2ConstPtr& lidar_cloud){
    ...
    sor_lidar.setLeafSize (0.15f, 0.15f, 0.15f);
    ...
    C_ = furthest_point_->PointToLaser(Points_To_Floor_filter);
...
int main(int argc, char** argv) {
    ...
    ros::Publisher velodyne_laser_pub = nh.advertise<sensor_msgs::LaserScan>("/scan_multi", 500);
