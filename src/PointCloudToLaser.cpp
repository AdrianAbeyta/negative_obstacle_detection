...
sensor_msgs::LaserScan PointCloudToLaser::FurthestPointExtraction( sensor_msgs::PointCloud2 cloud_filtered){
...
sensor_msgs::LaserScan PointCloudToLaser::VirtualFloorProjection( sensor_msgs::PointCloud2 cloud_filtered ){
    sensor_msgs::LaserScan  scan;
...
sensor_msgs::LaserScan PointCloudToLaser::PointToLaser( const sensor_msgs::PointCloud2ConstPtr&  cloud_filtered ){
...
sensor_msgs::LaserScan PointCloudToLaser::CombineLaserScans( sensor_msgs::LaserScan  array_a, sensor_msgs::LaserScan  array_b , sensor_msgs::LaserScan  array_c){
